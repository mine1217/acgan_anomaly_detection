...
class ACGAN:
    ...
    def train(
        ...
        plt.plot(range(0, 100), plt_loss[0][:100], linewidth=1, label="d_loss", color="red")
        plt.plot(range(0, 100), plt_loss[1][:100], linewidth=1, label="g_loss", color="blue")
...
def main():
    ...
    acgan.train(x_train, y_train, iterations=1000, batch_size=32,
                interval=100)
