...
do
    ...
    python3 src/experiments/plot_data.py --input output/experiments/generated_data/acanogan/${device_id}_${i}_normal.csv --save output/elect_graph/generated/acanogan/${device_id}_${i}_normal/
    python3 src/experiments/plot_data.py --input output/experiments/generated_data/acanogan/${device_id}_${i}_anomaly.csv --save output/elect_graph/generated/acanogan/${device_id}_${i}_anomaly/
done